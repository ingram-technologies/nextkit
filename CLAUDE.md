...
`financica` (a sibling repo) is our highest-quality codebase and the source of
most conventions here. When in doubt about a pattern, check how financica does
it.
